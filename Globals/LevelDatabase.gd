...
var levels : Array[Array] = [ # starting_word, target_word, solution(conjoined), sulution comma seperated
	["POT", "GEM", "GEM",
	"POT,GOT,GET,GEM"],
	["CARD", "GAME", "EMG",
	"CARD,CARE,CAME,GAME"],
	["RING", "LIFE", "DELF", 
	"RING,DING,DINE,LINE,LIFE"],
	["CARE", "BEAR", "BKEAR", 
	"CARE,BARE,BARK,BERK,BEAK,BEAR"],
	["CARD", "KING", "BNIKG", 
	"CARD,BARD,BAND,BIND,KIND,KING"],
	["GLASS", "SHARD", "CPHRDS", 
	"GLASS,CLASS,CLAPS,CHAPS,CHARD,SHARD"],
	["SLIDE", "COAST", "GABSTOC",
	"SLIDE,GLIDE,GLADE,BLADE,BLASE,BLAST,BOAST,COAST"],
	["WATER", "SPILL", "HDRISHIPLL",
	"WATER,HATER,HATED,HARED,HIRED,SIRED,SHRED,SHIED,SPIED,SPIEL,SPILL"], # Need to find better stuff for this
