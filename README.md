...
- Added a Tutorial
- Added 2 new colors Teal and Green
- Added hint when a word isn't found in the dictionary
- Updated the boot splash art
...
## Coming Soon(ish):
- Daily streaks and personal records
- Timed Attack Mode
- Puzzle Reset Button (instead of hitting undo a whole bunch of times)
- EVEN MORE PUZZLES!! (while making the puzzle files more compressed)
- Better Credits screen (maybe)